...
async def get_reservations(
    ...
    if reservation_from:
        query = query.where(HydrogenStationReservation.reservation_time >= reservation_from)

    if reservation_to:
        query = query.where(HydrogenStationReservation.reservation_time <= reservation_to)

    if expire_from:
        query = query.where(HydrogenStationReservation.expire_time >= expire_from)

    if expire_to:
        query = query.where(HydrogenStationReservation.expire_time <= expire_to)
